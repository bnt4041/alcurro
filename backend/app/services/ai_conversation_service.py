...
def _build_actions_catalog(
    ...
    _TPL: dict[str, dict] = {
        ...
        "vacaciones_pendientes":     {"c":"vacaciones_pendientes","n":"Vacaciones pendientes de aprobar","d":"Lista solicitudes de vacaciones pendientes del equipo","cat":"vacaciones","cf":False,"p":{},"cq":None,"tr":["vacaciones pendientes","solicitudes pendientes","que vacaciones tengo por aprobar","pendientes de aprobar","vacaciones por aprobar"]},
        "aprobar_vacaciones":        {"c":"aprobar_vacaciones","n":"Aprobar vacaciones","d":"Aprobar o rechazar solicitudes de vacaciones del equipo","cat":"vacaciones","cf":False,"p":{},"cq":None,"tr":["aprobar vacaciones","aprueba las vacaciones","rechazar vacaciones","gestionar vacaciones","revisar solicitudes"]},
        "incidencias_abiertas":      {"c":"incidencias_abiertas","n":"Incidencias abiertas","d":"Muestra las incidencias abiertas del equipo","cat":"incidencias","cf":False,"p":{},"cq":None,"tr":["incidencias abiertas","ver incidencias","muestra las incidencias","incidencias activas","incidencias del equipo"]},
        "incidencias_sin_gestionar": {"c":"incidencias_sin_gestionar","n":"Incidencias sin gestionar","d":"Muestra las incidencias del equipo sin gestionar","cat":"incidencias","cf":False,"p":{},"cq":None,"tr":["incidencias sin gestionar","incidencias por gestionar","incidencias no gestionadas","incidencias sin revisar"]},
    }
